...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/whatstarwebshow')
            ],
            [
                InlineKeyboardButton('ᴅɪꜱ. ɢʀᴏᴜᴘ', url=f"https://t.me/+oC5w_-ZoVo5mN2Nl"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('ᴅɪꜱ. ɢʀᴏᴜᴘ', url='https://t.me/+oC5w_-ZoVo5mN2Nl'),
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/whatstarwebshow')
            ],[
